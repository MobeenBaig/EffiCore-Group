...
import meetingImg from '../assets/pcmh.png';
        ...
        <section style={{
          ...
          <div style={{ width: '100%', height: '100%', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }} className="content-grid">
            ...
            <div className="content-text" style={{
              ...
              <h2 className="section-title" style={{fontSize: 'clamp(1.5rem, 4vw, 2rem)', fontWeight: 800, color: 'var(--teal-dark)', marginBottom: 18}}>PCMH</h2>
