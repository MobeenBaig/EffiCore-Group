...
const practiceOpFeatures = [
  'Billing & Claims Process Review',
  'Documentation & Compliance Assessment',
  'Accounts Receivable & Revenue Cycle Analysis',
  'Patient Scheduling & Front Desk Efficiency',
  'Workflow & Operational Bottleneck Identification',
  'Recommendations for Process Improvement & Growth',
];
      ...
      <div style={{ fontFamily: "'Nunito', sans-serif", overflowX: 'hidden' }}>
        <div className="page-hero" style={{
          ...
          <div className="container" style={{position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%'}}>
            <h1 className="section-title" style={{fontSize: 'clamp(2rem, 6vw, 4.5rem)', fontWeight: '800', marginBottom: 12, color: 'white', animation: 'fadeUp 0.7s 0.1s ease both'}}>Practice Operations Audit</h1>
            <div className="section-tag" style={{marginBottom: 18, color: '#4ECDC4', fontSize: 'clamp(1rem, 3.2vw, 1.25rem)', animation: 'fadeUp 0.7s 0s ease both'}}>
              <Link to="/" style={{color: 'inherit', textDecoration: 'none', cursor: 'pointer', transition: 'opacity 0.2s'}}>Home</Link> &gt; Practice Operations Audit
            </div>
        ...
        <section style={{
          ...
          <div style={{ width: '100%', height: '100%', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
            ...
            <div style={{
              ...
              <h2 className="section-title" style={{fontSize: 'clamp(1.5rem, 4vw, 2rem)', fontWeight: 800, color: 'var(--teal-dark)', marginBottom: 18}}>Practice Operations Audit</h2>
              <p style={{fontSize: 'clamp(0.95rem, 3vw, 1.08rem)', color: 'var(--text-mid)', lineHeight: 1.7, marginBottom: 0}}>
Running a successful healthcare practice requires more than providing excellent care—it demands efficient operations, optimized workflows, and a clear understanding of revenue opportunities. Many practices overlook gaps in billing, documentation, scheduling, or compliance that can impact revenue and efficiency. Our complimentary Practice Operations Audit is designed to identify these gaps and provide actionable insights for improvement.

We review all critical areas of your practice, including billing, documentation, patient scheduling, accounts receivable, and workflow efficiency. We analyze current operations, uncover missed opportunities, and provide a detailed report highlighting revenue optimization, process improvements, and compliance enhancement. Our goal is to empower your practice to maximize efficiency, reduce revenue leakage, and improve patient satisfaction—giving you a risk-free opportunity to see how expert insights can transform your operations.              </p>
            </div>
          ...
          <div className="desktop-layout" style={{
            ...
            <div style={{
              ...
              <div className="section-header" style={{marginBottom: 64, position: 'relative', zIndex: 1}}>
                <div className="section-tag" style={{color: 'var(--teal-dark)', fontSize: 'clamp(1.25rem, 3vw, 1.65rem)', fontWeight: 800, letterSpacing: '0.4px', marginBottom: 16, display: 'inline-block'}}>What Our Audit Covers </div>
              </div>
              <div className="billing-steps" style={{
                ...
                <div className="step-card reveal" style={{
                  ...
                  <div style={{
                    ...
                    {practiceOpFeatures.map((feature, idx) => (
                      <div key={idx} style={{
                        display: 'flex',
                        gap: 12,
                        alignItems: 'flex-start',
