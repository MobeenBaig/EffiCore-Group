...
const hedisFeatures = [
  ...
  'Timely submission of required HEDIS reports to meet compliance standards.',
  'Identification and closure of care gaps to improve quality scores.',
  'Assistance with medical record review and documentation validation.',
  'Customized strategies to maximize performance and payer incentives.',
  'Clear reporting and actionable insights to monitor ongoing improvement.',
];
      ...
      <div style={{ fontFamily: "'Nunito', sans-serif", overflowX: 'hidden' }}>
        <div className="page-hero" style={{
          ...
          <div className="container" style={{position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%'}}>
            <h1 className="section-title" style={{fontSize: 'clamp(2rem, 6vw, 4.5rem)', fontWeight: '800', marginBottom: 12, color: 'white', animation: 'fadeUp 0.7s 0.1s ease both'}}>HEDIS</h1>
        ...
        <section style={{
          ...
          <div style={{ width: '100%', height: '100%', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }} className="content-grid">
            ...
            <div className="content-text" style={{
              ...
              <h2 className="section-title" style={{fontSize: 'clamp(1.5rem, 4vw, 2rem)', fontWeight: 800, color: 'var(--teal-dark)', marginBottom: 18}}>HEDIS</h2>
              <p style={{fontSize: 'clamp(0.95rem, 3vw, 1.08rem)', color: 'var(--text-mid)', lineHeight: 1.7, marginBottom: 0}}>
HEDIS (Healthcare Effectiveness Data and Information Set) plays a vital role in measuring the 
quality and performance of healthcare services. It is widely used by health plans to evaluate care 
outcomes, compliance, and patient satisfaction. Managing HEDIS requirements can be complex 
and time-sensitive, requiring accurate data collection, thorough documentation, and strict 
adherence to guidelines. 
Our HEDIS support services are designed to help healthcare providers meet performance 
benchmarks with confidence. We assist in data abstraction, medical record review, gap 
identification, and timely submission of required measures. By ensuring accurate and complete 
reporting, we help you improve quality scores, enhance compliance, and strengthen your standing 
with payers. 
With a detail-oriented approach and consistent monitoring, we help close care gaps and optimize 
your overall performance. Our team provides clear reporting and actionable insights, allowing you 
to track progress and make informed decisions. While we handle the intricacies of HEDIS, you can 
stay focused on delivering high-quality patient care and achieving better outcomes.               </p>
            </div>
          ...
          <div className="desktop-layout" style={{
            ...
            <div style={{
              ...
              <div className="section-header" style={{marginBottom: 64, position: 'relative', zIndex: 1}}>
                <div className="section-tag" style={{color: 'var(--teal-dark)', fontSize: 'clamp(1.25rem, 3vw, 1.65rem)', fontWeight: 800, letterSpacing: '0.4px', marginBottom: 16, display: 'inline-block'}}>Our HEDIS Services</div>
              </div>
