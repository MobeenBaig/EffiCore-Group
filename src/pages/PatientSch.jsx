...
export default function PatientSch() {
      ...
      <div style={{ fontFamily: "'Nunito', sans-serif", overflowX: 'hidden' }}>
        <div className="page-hero" style={{
          ...
          <div className="container" style={{position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%'}}>
            <h1 className="section-title" style={{fontSize: 'clamp(2rem, 6vw, 4.5rem)', fontWeight: '800', marginBottom: 12, color: 'white', animation: 'fadeUp 0.7s 0.1s ease both'}}>Patient Scheduling</h1>
            <div className="section-tag" style={{marginBottom: 18, color: '#4ECDC4', fontSize: 'clamp(1rem, 3.2vw, 1.25rem)', animation: 'fadeUp 0.7s 0s ease both'}}>
              <Link to="/" style={{color: 'inherit', textDecoration: 'none', cursor: 'pointer', transition: 'opacity 0.2s'}}>Home</Link> &gt; Patient Scheduling
            </div>
...
Efficient patient scheduling is the foundation of a well-organized and profitable practice. Missed calls, long wait times, and scheduling errors can negatively impact revenue and patient experience. Our in-house call center ensures every patient interaction is handled promptly and professionally. Trained representatives manage incoming and outgoing calls, appointment bookings, rescheduling, and cancellations using customized scripts tailored to your practice, including insurance verification and accurate information collection.

Beyond scheduling, we optimize your calendar to reduce no-shows and improve patient flow through reminders, follow-ups, and real-time updates. Acting as an extension of your front desk, our team maintains a seamless experience for every patient. With our call center handling communication, your practice can enhance operational efficiency, increase revenue, and deliver superior patient care without the added administrative burden.              </p>
            </div>
          ...
          <div className="desktop-layout" style={{
            ...
            <div style={{
              ...
              <div className="section-header" style={{marginBottom: 64, position: 'relative', zIndex: 1}}>
                <div className="section-tag" style={{color: 'var(--teal-dark)', fontSize: 'clamp(1.25rem, 3vw, 1.65rem)', fontWeight: 800, letterSpacing: '0.4px', marginBottom: 16, display: 'inline-block'}}>What We Handle</div>
              </div>
              <div className="billing-steps" style={{
                ...
                <div className="step-card reveal" style={{
                  ...
                  <div style={{
                    ...
                    marginBottom: 20,
                    letterSpacing: 0.5,
                  }}>Our Patient Scheduling Services</div>
                  <div style={{
                    display: 'flex',
                    flexDirection: 'column',
                    gap: 16,
                  }}>
                    {patientSchFeatures.map((feature, idx) => (
                      <div key={idx} style={{
                        display: 'flex',
                        gap: 12,
                        alignItems: 'flex-start',
